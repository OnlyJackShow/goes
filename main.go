...
func Write() {
	// 创建创建一条微博
	msg1 := Weibo{User: "olive111re", Message: "打酱油的一天11111", Retweets: 11110}
...
func create() {
	...
	//使用结构体
	e1 := Employee{"张", "震", 26, "中国人", []string{"music"}}


	fmt.Print(e1)

	kk,_:=json.Marshal(e1)
...
func Ss()  {
	res, err :=Esclient.Search("student").Type("student").Do(context.Background())
	if err!=nil {
